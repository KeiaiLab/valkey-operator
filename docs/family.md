...
You are reading this from the **`valkey-operator`** repository. This page is the canonical cross-link for the entire family.
...
| Task | Entry point |
|---|---|
| Deploy `valkey-operator` on Kubernetes | [README.md](../README.md) Quickstart section |
