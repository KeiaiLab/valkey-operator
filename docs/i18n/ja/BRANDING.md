...
**Organization**: [keiailab](https://keiailab.com) — Kubernetes-native なデータプラットフォーム operator (MIT ライセンス、license-clean、vanilla-upstream 互換)。

**Project**: `valkey-operator` — Kubernetes 向け MIT-licensed Valkey Operator — Standalone + Cluster + Backup/Restore、BSD-3 license-clean。
