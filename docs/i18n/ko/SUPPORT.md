...
| Prometheus 알람에 걸려서 MTTR 절차가 필요합니다. | [`docs/operations/runbook.md`](../../operations/runbook.md) §9 (모든 알람의 `runbook_url` annotation 이 여기를 가리킵니다). |
| 알람은 없지만 이상한 동작이 보입니다. | [`docs/operations/troubleshooting.md`](../../operations/troubleshooting.md) — 증상 → 원인 → 진단 → 조치 흐름도. |
...
2. [troubleshooting 흐름도](../../operations/troubleshooting.md) 를 시도하세요.
3. 보고서에 다음을 준비해 두세요:
