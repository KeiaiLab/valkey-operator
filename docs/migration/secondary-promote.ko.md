# Secondary-Promote 컷오버 (한국어)

> English: [secondary-promote.md](secondary-promote.md) — canonical / 정본
...
- 1단계: `WAIT` 출력 ≥1
- 3단계: 새 primary 의 `INFO replication` role:master
- 5단계: 연속 write 100건 PASS

## 참조 (Refs)

- ROADMAP.md (P-C.3.2)
- `zero-downtime.ko.md` (상위 흐름)
