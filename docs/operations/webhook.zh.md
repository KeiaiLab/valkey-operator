...
> 与
> [mongodb-operator 的 webhook 文档](https://github.com/keiailab/mongodb-operator/blob/main/docs/advanced/webhook.md)
> 同一套模式 —— 通过 3-operator cross-cut audit (ADR-0016) 保证不变式
> 与 UX 一致。
