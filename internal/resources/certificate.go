...
//
// Bitnami chart 의 `tls.autoGenerated` 동등 — 사용자가 cert-manager 만 설치해두면
// IssuerRef 명시 없이 *operator-issued root* 로 TLS 활성. CRD 미설치 시 unstructured
// apply 가 NoMatchError fail-soft (ADR-0010 패턴).
